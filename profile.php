								...
								<form id="login-form" method="post">
									<div class="single-contact-form">
										<div class="contact-box name">
											<input type="text" name="name" id="name" placeholder="Your Name*" style="width:100%" value="<?php echo $_SESSION['name']?>">
										</div>
							...
							<div class="col-xs-12">
								<form method="post" id="frmPassword">
									...
									<div class="single-contact-form">
										...
										<span class="field_error" id="confirm_new_password_error"></span><br>
									</div>
