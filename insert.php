...
$posted['txnid']=$txnid;
$posted['amount']=100;
$posted['firstname']="Harsh";
$posted['email']="harsh@gmail.com";
...
.$posted['productinfo'].'</textarea><input type="hidden" name="surl"
 value="http://91weblessons.com/payu/payment_complete.php" /><input type="hidden" name="furl"
  value="http://91weblessons.com/payu/payment_fail.php"/><input type="submit" style="display:none;"/></form>';
echo $formHtml;
